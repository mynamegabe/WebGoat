...
public class SqlInjectionLesson5b implements AssignmentEndpoint {
  ...
  protected AttackResult injectableQuery(String login_count, String accountName) {
    // Both values are bound as parameters, neither one is part of the statement text.
    ...
    try (Connection connection = dataSource.getConnection()) {
      ...
      try {
        ...
        return failed(this)
            .output("Could not parse the login count<br> Your query was: " + queryString)
            .build();
      }
      ...
      try {
        ...
        return failed(this)
            .output("Could not parse the user id<br> Your query was: " + queryString)
            .build();
      }
      ...
      try {
        ...
        if ((results != null) && (results.first() == true)) {
          ...
          if (results.getRow() >= 6) {
            ...
            return failed(this)
                .output(output.toString() + "<br> Your query was: " + queryString)
                .build();
          }
        ...
        return failed(this)
            .output(sqle.getMessage() + "<br> Your query was: " + queryString)
            .build();
      }
    } catch (Exception e) {
      return failed(this)
