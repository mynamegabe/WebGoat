...
public class CrossSiteScriptingLesson5a implements AssignmentEndpoint {
  ...
  public AttackResult completed(
    ...
    // The credit card number is echoed back into the confirmation page, so it is HTML encoded
    // here. Any markup in the input is rendered as text and can no longer be executed.
    ...
    cart.append("<p>We have charged credit card:" + creditCard + "<br />");
    cart.append("                             ------------------- <br />");
