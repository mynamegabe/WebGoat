...
public class JWTSecretKeyEndpoint implements AssignmentEndpoint {
  ...
  // The signing key is a random 512 bit value, it can no longer be guessed from a word list
  ...
  private static String generateSecret() {
    ...
    return TextCodec.BASE64.encode(Base64.getEncoder().encodeToString(secret));
  }
