...
public class BypassRestrictionsFrontendValidation implements AssignmentEndpoint {
  ...
  public AttackResult completed(
    ...
    // The validation the browser performs is repeated here, input which does not match the
    // expected format is rejected instead of being trusted because the client said it was valid.
