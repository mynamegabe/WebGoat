...
public class SSRFTask2 implements AssignmentEndpoint {
  ...
  protected AttackResult furBall(String url) {
    // The server never opens a connection to the location it receives, it only serves the
    // images belonging to this page after checking them against a server side allow list.
