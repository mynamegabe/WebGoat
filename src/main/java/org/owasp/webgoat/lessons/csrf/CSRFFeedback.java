...
public class CSRFFeedback implements AssignmentEndpoint {
  ...
  public AttackResult completed(HttpServletRequest request, @RequestBody String feedback) {
    // A cross site form post can only use one of the simple content types, feedback is JSON so
    // anything else is refused before it is looked at.
    ...
    // On top of that the request has to come from WebGoat itself, a request triggered by another
    // site is never accepted.
