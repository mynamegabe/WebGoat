...
public class MissingFunctionAC extends Lesson {
  ...
  // These salts are the transform the lesson asks the reader to apply, not what protects the
  // hashes. What protects them is that the endpoints listing users now resolve the caller's role
  // server side and answer 403 to everybody else.
